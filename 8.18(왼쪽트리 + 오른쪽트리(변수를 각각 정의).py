...
e = TNode('E',None,None) # D 삽입, 자식 없음
d = TNode('D',None,None)
c = TNode('C',None,None) # B 삽입, 왼쪽 자식 -> d, 오른쪽 자식 -> e
b = TNode('B',None,None)
a = TNode('A',None,None) # C 삽입, 왼쪽 자식 -> f, 오른쪽 자식 -> 없음

slash = TNode('/',a, b)
aster2 = TNode('*',slash, c)
aster1 = TNode('*',aster2,d)
root = TNode('+',aster1,e) # 루트 노드에 A 삽입, 왼쪽 자식 -> b, 오른쪽 자식 -> c
